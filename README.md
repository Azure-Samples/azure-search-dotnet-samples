...
| quickstart-agentic-retrieval-image-serving | [Agentic retrieval with image serving](https://learn.microsoft.com/azure/search/agentic-retrieval-how-to-image-serving) | Uses managed ingestion to extract images, serves them during answer synthesis, and downloads a referenced image from blob storage. |
